...
namespace Cryozonic\StripeSubscriptions\Model\Order;

use Cryozonic\StripeSubscriptions\Model\InitialFee;
...
class InitialFeeManagement
{
    ...
    public function setFromData(Order $order): Order
    {
    ...
    public function setFromAddressData(Order $order, QuoteAddress $address): Order
    {
    ...
    public function setDataFrom(Order $order): Order
    {
