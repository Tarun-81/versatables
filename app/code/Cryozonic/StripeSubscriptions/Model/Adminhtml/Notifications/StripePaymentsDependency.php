...
namespace Cryozonic\StripeSubscriptions\Model\Adminhtml\Notifications;

class StripePaymentsDependency implements \Magento\Framework\Notification\MessageInterface
{
    public $requiredStripePaymentsVersion = "2.3.0";
    ...
    {
        return 'cryozonic_stripesubscriptions_notification_stripepayments_dependency';
    }
    ...
    public function getText()
    {
        ...
        {
            return "<strong>Stripe Payments is not installed</strong> - The Stripe Subscriptions add-on requires the core module <a href=\"{$this->stripePaymentsLink}\" target=\"_blank\">Stripe Payments v{$this->requiredStripePaymentsVersion}</a> to be installed, but an installation of the module was not found.";
        }
