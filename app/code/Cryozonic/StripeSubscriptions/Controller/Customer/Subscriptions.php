...
namespace Cryozonic\StripeSubscriptions\Controller\Customer;
...
class Subscriptions extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if (isset($params['viewOrder']))
            ...
            $this->_redirect('cryozonic-stripesubscriptions/customer/subscriptions');
    ...
    protected function editSubscription($subscriptionId, $data)
    {
        try
        {
            $editableContent = \Cryozonic\StripeSubscriptions\Block\Customer\Subscriptions::editableContent();
