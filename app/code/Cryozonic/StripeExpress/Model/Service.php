...
class Service implements ServiceInterface
{
    ...
    public function set_billing_address($source)
    {
        try {
            ...
            // Place Order
            $billingAddress = $this->helper->getBillingAddress($source);
    ...
    public function place_order($result)
    {
        ...
        try {
            ...
            $quote->getPayment()->setAdditionalInformation('token', $sourceId);
            $quote->getPayment()->setAdditionalInformation('source_id', $sourceId);
